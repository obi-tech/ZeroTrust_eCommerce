...
class OrderManagementStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateOrder = channel.unary_unary(
                '/ordermanagement.OrderManagement/UpdateOrder',
                request_serializer=order__management__pb2.OrderUpdateRequest.SerializeToString,
                response_deserializer=order__management__pb2.OrderResponse.FromString,
                _registered_method=True)
        self.DeleteOrder = channel.unary_unary(
                '/ordermanagement.OrderManagement/DeleteOrder',
                request_serializer=order__management__pb2.OrderId.SerializeToString,
                response_deserializer=order__management__pb2.DeleteResponse.FromString,
                _registered_method=True)
...
def add_OrderManagementServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__management__pb2.OrderUpdateRequest.FromString,
                    response_serializer=order__management__pb2.OrderResponse.SerializeToString,
            ),
            'DeleteOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteOrder,
                    request_deserializer=order__management__pb2.OrderId.FromString,
                    response_serializer=order__management__pb2.DeleteResponse.SerializeToString,
            ),
    }
...
class OrderManagement(object):
    ...
    def UpdateOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ordermanagement.OrderManagement/UpdateOrder',
            order__management__pb2.OrderUpdateRequest.SerializeToString,
            order__management__pb2.OrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def DeleteOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/ordermanagement.OrderManagement/DeleteOrder',
            order__management__pb2.OrderId.SerializeToString,
            order__management__pb2.DeleteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
